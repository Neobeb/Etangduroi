(function initEtangGame(root) {
  ...
  const CARDS = [
    ...
    { id: "chevalier", name: "Chevalier", qty: 3, type: "Grenouille", base: 2, mode: "adjacent", pos: ["Oiseau"], value: 4, antiHeron: true, text: "+4 par Oiseau adjacent. Annule un Heron adjacent.", asset: "chevalier.png" },
    ...
    { id: "capitaine", name: "Capitaine", qty: 1, type: "Noble", base: 2, mode: "adjacent", pos: ["Oiseau"], value: 5, antiHeron: true, text: "+5 par Oiseau adjacent. Annule un Heron adjacent.", asset: "capitaine.png" },
    ...
    return {
      ...
      game: game ? {
        ...
        players: game.players.map(player => ({
          ...
          index: player.index,
          score: player.score,
          cardScore: rawBoardScore(player),
          grail: player.grail,
          grailPoints: player.grail ? 10 : 0,
          win: player.win,
